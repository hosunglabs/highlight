 ...
 */
public class CropImageView extends FrameLayout implements CropOverlayView.OnOverlayTouchListener {

    private static final String TAG = CropImageView.class.getName();

    //region: Fields and Consts
    public interface OnOverlayTouchHappenListener {
        void OnOverlayTouchHappen(CropImageView v, MotionEvent event);
    }

    private OnOverlayTouchHappenListener overlayTouchHappenListener;

    public void setOnOverlayTouchHappenListener(OnOverlayTouchHappenListener listener) {
        overlayTouchHappenListener = listener;
    }
    ...
    public CropImageView(Context context, AttributeSet attrs) {
        ...
        mCropOverlayView.setOnOverlayTouchListener(this);
    }

    @Override
    public void OnOverlayTouch(CropOverlayView v, MotionEvent event) {
        Log.d(TAG,"ACTION_UP: CropImageView");
        if (overlayTouchHappenListener != null) {
            overlayTouchHappenListener.OnOverlayTouchHappen(this, event);
        }
    }
