...
public class CropOverlayView extends View {
    ...
    private static final String TAG = CropOverlayView.class.getName();

    public interface OnOverlayTouchListener {
        void OnOverlayTouch(CropOverlayView v, MotionEvent event);
    }

    private OnOverlayTouchListener overlayTouchListener;

    public void setOnOverlayTouchListener(OnOverlayTouchListener listener) {
        overlayTouchListener = listener;
    }
        ...
        if (isEnabled()) {
            switch (event.getAction()) {
                ...
                case MotionEvent.ACTION_UP:
                    if(overlayTouchListener != null) {
                        Log.d(TAG, "ACTION_UP: CropOverlayView");
                        overlayTouchListener.OnOverlayTouch(this, event);
                    }
